...
class MLTrainer:    def __init__(self):
    ...
    def load_data(self):
        ...
        try:
            ...
            # Make sure the current script directory is in the path
    ...
    def prepare_course_recommendation_data(self):
        ...
        rec_data['nivel_encoded'] = le_nivel.fit_transform(rec_data['nivel'].astype(str))
        rec_data['turno_encoded'] = le_turno.fit_transform(rec_data['turno'].astype(str))
    ...
    def train_enrollment_prediction_model(self):
        ...
        self.models['enrollment_prediction'] = rf_model
        self.scalers['enrollment_prediction'] = scaler
